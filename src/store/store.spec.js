...
describe("Store", () => {
    ...
    describe("actions", () => {
        ...
        it("updateProducts", () => {
            ...
            expect(commit).toHaveBeenCalledWith("updateProductsStatus", {loading: false});
        ...
        it("fetchProducts with request succeeding", async () => {
            ...
            expect(commit).toHaveBeenCalledWith("updateProductsStatus", {loading: true});
        ...
        it("fetchProducts with request failing", async () => {
            ...
            expect(commit).toHaveBeenCalledTimes(2);
            expect(commit).toHaveBeenCalledWith("updateProductsStatus", {loading: true});
            expect(commit).toHaveBeenLastCalledWith("updateProductsStatus", {error: error});
            expect(dispatch).toHaveBeenCalledTimes(1);
